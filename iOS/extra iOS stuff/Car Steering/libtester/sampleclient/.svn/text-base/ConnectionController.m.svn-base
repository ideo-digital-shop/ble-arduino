...
/* CarController needs to access GenericDevice instance in order to send control signals */
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    CarController *carController = [segue destinationViewController];
    carController.device = self.d; 
}
