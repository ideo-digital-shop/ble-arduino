...
- (void) alarmServiceDidChangeStatus:(LeTemperatureAlarmService*)service
{
    if ( [[service peripheral] isConnected] ) {
        ...
        NSLog(@"Peripheral UUID: %@", service.peripheral.UUID);
        NSLog(@"Current temp: %@", service.temperature);
        NSLog(@"Peripheral description: %@", service.peripheral.debugDescription);
...
{  
    NSLog(@"In function: didSelectRowAtIndexPath");
	...
	if (![peripheral isConnected]) {
        ...
        NSLog(@"currentlyDisplayingService: %@", currentlyDisplayingService);
...
- (IBAction) maxStepperChanged
{
    NSLog(@"In function: maxStepperChanged");
...
- (IBAction) minStepperChanged
{
    NSLog(@"In function: minStepperChanged");
